...
**[대응]** 회신/결정/승인 필요한 메일. 본문 읽고 액션 추출.

- [대응] **메일 제목** — 발신자 (HH:MM)
  핵심 2~3줄: 상대방 요청, 맥락, 마감
  → **액션**: 구체적 할 일

**[주요]** 내 논문/과제/학생/사업 직접 관련. 원문 안 열어도 OK.

- [논문] **제목** — 발신자 (HH:MM): 핵심 1줄
- [과제] **제목** — 발신자 (HH:MM): 핵심 1줄
- [학생] **제목** — 발신자 (HH:MM): 핵심 1줄

**[비주요]** 불릿 없이 한 줄씩. 같은 유형은 묶어라.

제목 — 발신자 (HH:MM)
학과 공지 (3건): 항목1, 항목2, 항목3`).join('\n\n---\n\n')
  : `### 수신 이메일
...
## 상세도 가이드 (매우 중요 — 반드시 준수)

| 구분 | 형식 | 예시 |
|------|------|------|
| [대응] | 불릿(-) + 2~3줄 + → 액션 | - [대응] **ACS AMI Revision** — Editor (09:30)\\n  Major revision 요청. 실험 2건 추가 필요. **마감 4/21**\\n  → 손가영에게 실험 계획 전달 |
| [주요] | 불릿(-) + **제목 — 발신자: 1줄** | - [논문] **Burns & Trauma 제출 확인** — Editorial Office (06:53): 제출 완료, 피드백 설문 수신 |
| [비주요] | **불릿 없이** 제목 — 발신자 한 줄 | 교수법 특강 안내 — 학부사무실 (10:00) |
| [비주요 묶음] | 유형 (N건): 항목 나열 | 학부 공지 (4건): 교수법 특강, SW 주의, 노천극장 소음예고, 포상 안내 |
| [광고] | 발신자 "·" 나열 | MRS · Hilton · Costco · Skyscanner · ICFPE |

**압축 원칙:**
- 브리핑은 "30초 스캔"이 목적. 메일함 복사가 아니다.
- [대응]만 상세. [주요]는 1줄. [비주요]는 제목만 or 묶음.
- [비주요]가 5건 이상이면 반드시 유형별 묶음 (3줄 이내).
- [광고]는 발신자 나열 1줄. 2줄 이상 금지.
- 해당 카테고리가 0건이면 소제목 자체를 생략.
- "할 일"에는 [대응] 액션만. 정보성 메일 포함 금지.`;
