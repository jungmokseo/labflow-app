...
| 구분 | 상세도 | 설명 |
|------|--------|------|
| [대응 필요] | ★★★ 최고 | 본문 2~3줄 + 맥락 + "→ 액션" 1줄. 이 메일만 읽으면 바로 행동 가능하게. |
| [주요 정보] | ★★ 중간 | 1~2줄 요약. 논문명/과제명/마감일 등 핵심 팩트 포함. 원문 안 열어도 OK. |
| [기타] | ★ 최소 | 제목 + 발신자 + 한 줄. 또는 동일 유형 다건 묶음. |
| [광고] | 없음 | 발신자: 제목만. "·"로 한 줄 나열. |
