...
- 권장 액션: Claude Team **$200** 크레딧 (4/17 마감)${userInstructions}`;
    ...
    const directResult = isEmailBriefingDirect ? shadowResult : dbResult;
    if ((isEmailBriefingDirect || (directPassthroughIntents.includes(intent) && directResult)) && directResult) {
