...
{"subject": "Re: 원본 제목", "body": "답장 본문"}`;
    ...
    if (emailDraftUsage) logApiCost(userId, 'gemini-3.5-flash', emailDraftUsage.promptTokenCount ?? 0, emailDraftUsage.candidatesTokenCount ?? 0, 'email_draft_reply').catch(() => {});
