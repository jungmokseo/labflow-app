  ...
  if (sent) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-bg px-4">
        <div className="w-full max-w-sm bg-bg-card border border-bg-input/50 rounded-xl p-6 shadow-xl text-center">
          <h2 className="text-lg font-semibold text-white mb-4">이메일을 확인해주세요</h2>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-bg px-4">
      ...
      <div className="w-full max-w-sm bg-bg-card border border-bg-input/50 rounded-xl p-6 shadow-xl">
        <h2 className="text-lg font-semibold text-white mb-6 text-center">회원가입</h2>
